...
import static com.kabelo.eshop.web.rest.TestUtil.sameNumber;
...
import com.kabelo.eshop.repository.ProductRepository;
import com.kabelo.eshop.service.dto.ProductDTO;
import com.kabelo.eshop.service.mapper.ProductMapper;
...
class ProductResourceIT {
    ...
    private static final Category DEFAULT_CATEGORY = Category.FRUITS;
    private static final Category UPDATED_CATEGORY = Category.VEGETABLE;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().category(DEFAULT_CATEGORY).title(DEFAULT_TITLE).price(DEFAULT_PRICE).imageUrl(DEFAULT_IMAGE_URL);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().category(UPDATED_CATEGORY).title(UPDATED_TITLE).price(UPDATED_PRICE).imageUrl(UPDATED_IMAGE_URL);
        return product;
    }
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.category(UPDATED_CATEGORY).title(UPDATED_TITLE).price(UPDATED_PRICE).imageUrl(UPDATED_IMAGE_URL);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.category(UPDATED_CATEGORY).title(UPDATED_TITLE).price(UPDATED_PRICE).imageUrl(UPDATED_IMAGE_URL);
